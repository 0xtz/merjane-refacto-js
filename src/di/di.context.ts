...
import {ProductHandlerService} from '@/services/impl/product-handler.service.js';
...
declare module '@fastify/awilix' {
	...
	interface Cradle { // eslint-disable-line @typescript-eslint/consistent-type-definitions
		...
		ps: ProductService;
		productHandler: ProductHandlerService;
	}
}
...
export async function configureDiContext(
	...
	diContainer.register({
		productHandler: asClass(ProductHandlerService),
	});
}
